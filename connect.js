require('../settings')
const { default: lexxyConnect, useSingleFileAuthState, useMultiFileAuthState, DisconnectReason, fetchLatestBaileysVersion, generateForwardMessageContent, prepareWAMessageMedia, generateWAMessageFromContent, generateMessageID, downloadContentFromMessage, makeInMemoryStore, jidDecode, proto } = require('@adiwajshing/baileys')
...
browser: ['YT: Neo403', 'safari', '1.0.0'],
auth: state
})

store.bind(lexxy.ev)
console.log(color(figlet.textSync('BUGME', {
font: 'Standard',
...
require('../nodeJS/lexxy')(lexxy, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
...
lexxy.relayMessage(jid, template.message, { messageId: template.key.id })
}
